...
type UpdateSettingsRequest struct {
	...
	HideSynarouteImportButton   bool                  `json:"hide_synaroute_import_button"` // [CUSTOM] 见 CUSTOMIZATIONS.md
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		HideSynarouteImportButton:              req.HideSynarouteImportButton, // [CUSTOM] 见 CUSTOMIZATIONS.md
	...
	payload := dto.SystemSettings{
		...
		HideSynarouteImportButton:                              updatedSettings.HideSynarouteImportButton, // [CUSTOM] 见 CUSTOMIZATIONS.md
