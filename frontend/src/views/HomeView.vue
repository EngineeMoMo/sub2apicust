<template>
  ...
  >
    ...
    <div class="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      ></div>
      <div
        class="absolute inset-0 bg-[linear-gradient(rgb(var(--color-primary-500)/0.03)_1px,transparent_1px),linear-gradient(90deg,rgb(var(--color-primary-500)/0.03)_1px,transparent_1px)] bg-[size:64px_64px]"
      ></div>
    </div>
