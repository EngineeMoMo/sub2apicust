        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              <!-- [CUSTOM] Hide SynaRoute Import Button（登记见 CUSTOMIZATIONS.md） -->
              <div
                class="flex items-center justify-between border-t border-gray-100 pt-4 dark:border-dark-700"
              >
                <div>
                  <label class="font-medium text-gray-900 dark:text-white">{{
                    t("admin.settings.site.hideSynarouteImportButton")
                  }}</label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.site.hideSynarouteImportButtonHint") }}
                  </p>
                </div>
                <Toggle v-model="form.hide_synaroute_import_button" />
              </div>
            </div>
          </div>
...
const form = reactive<SettingsForm>({
  ...
  hide_synaroute_import_button: false, // [CUSTOM] 见 CUSTOMIZATIONS.md
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      hide_synaroute_import_button: form.hide_synaroute_import_button, // [CUSTOM] 见 CUSTOMIZATIONS.md
